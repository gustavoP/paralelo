...
vra_wu = read.csv(file="/home/jeff/datasets/vra_wu/vra_wu.csv", header=TRUE)
aerodromos = read.csv(file="/home/jeff/datasets/vra_wu/Glossario_de_Aerodromo.csv", header = TRUE)
toc()
```
